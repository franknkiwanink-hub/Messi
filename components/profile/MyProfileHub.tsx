...
export default function MyProfileHub({ initialTab }: { initialTab?: ParentTab }) {
  ...
  async function handleSaveAccount() {
    ...
    if (newUsername.length < 5) {
      setAccountErr("Username must be at least 5 characters.");
      return;
    }
    if (newUsername.length > 15) {
      setAccountErr("Username cannot exceed 15 characters.");
      return;
    }
    if (!/^[a-zA-Z0-9_.-]+$/.test(newUsername)) {
      setAccountErr("Username can only contain letters, numbers, underscores, hyphens, and dots.");
      return;
    }
      ...
      <div className="pm-modal" style={{ minHeight: "100vh" }}>
        ...
        <div className="pm-modal-content">
          ...
          <div className="pm-quick-row" style={{ position: "relative", zIndex: 1 }}>
            <button className="pm-quick-btn pm-ai-btn" onClick={() => router.push("/aiagent")}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="pm-sub-tab-content active">
                  <div className="pm-input-group">
                    ...
                    <input
                      ...
                      maxLength={15}
                    />
                    <span className="pm-hint">Can be changed once every 7 days.</span>
                  </div>
                  <div className="pm-input-group">
                    ...
                    />
                    <span className="pm-hint">Up to 2 changes every 30 days.</span>
                  </div>
                  {accountErr ? (
