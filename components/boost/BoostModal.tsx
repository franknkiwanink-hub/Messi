...
//
// Prices are display-only copy, same as the original's own comment says:
// the price actually charged is enforced server-side in /api/paypal's
// handleBoostListing (reading LIMITS.boost.plans), so BOOST_PLANS here
// exists purely for rendering and must be kept in sync manually.
//
...
const BOOST_PLANS: { days: number; price: number; label: string; badge?: "popular" | "best" }[] = [
  { days: 1, price: 2.99, label: "1 day" },
  { days: 3, price: 6.99, label: "3 days" },
  { days: 7, price: 12.99, label: "7 days", badge: "popular" },
  { days: 14, price: 19.99, label: "14 days" },
  { days: 21, price: 27.99, label: "21 days" },
  { days: 30, price: 34.99, label: "30 days", badge: "best" },
];
